...
@section('content')
    <h1 class="h3 mb-3">Add New Exam</h1>
    ...
    <form action="{{ route('teacher.exams.store') }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <textarea name="instructions" rows="5" class="form-control" required></textarea>
            </div>
            ...
            <div class="col-md-6 mb-3">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="time" class="form-control" min="1" value="1" required>
                        @error('time')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="point" class="form-control" min="1" value="1" required>
                        @error('point')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="col-12 mb-4">
                <select name="questions[]" class="form-select selec2" id="questions" multiple></select>
            </div>
        ...
        <div class="d-flex justify-content-between">
            <a href="{{ route('teacher.exams.index') }}" class="btn btn-dark">Back</a>
    ...
    <script>
        ...
        function loadQuestions(id = null) {
            ...
            $.ajax({
                ...
                url: `${window.location.origin}/teacher/questions?cat=${category}&search=${$("#search").val()}`,
