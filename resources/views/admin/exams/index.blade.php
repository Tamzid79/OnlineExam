...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            <a href="{{route('admin.exams.create')}}" class="btn btn-primary">Add New</a>
        </div>
                    ...
                    <tbody>
                        @foreach ($data as $i)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.exams.edit', $i->id) }}" class="btn btn-info">
                                        <i class="align-middle" data-feather="edit"></i>
                                    </a>
                                    <a href="{{ route('admin.exams.show', $i->id) }}" class="btn btn-primary" title="All Submissions">
