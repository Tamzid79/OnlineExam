...
class examController extends Controller
{
    ...
    {
        $data = Exam::with('course', 'user')->latest()->get();
    ...
    public function create()
    {
        ...
        return view('admin.exams.add', compact('courses', 'categories'));
    }
    ...
    public function edit(Exam $exam)
    {
        $courses = Course::latest()->get();
        $categories = Category::latest()->get();
        return view('admin.exams.edit', compact('exam', 'courses', 'categories'));
    }
